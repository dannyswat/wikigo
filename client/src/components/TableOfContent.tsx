...
export default function TableOfContent({ title, content }: TableOfContentProps) {
    ...
    return (
        <div className="w-64 max-h-96 overflow-y-auto bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg shadow-lg p-4 sticky top-4">
            <h4 className="text-sm font-semibold mb-3 text-gray-900 dark:text-gray-100 border-b border-gray-200 dark:border-gray-700 pb-2">
